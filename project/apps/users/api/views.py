...
from .serializers import EmailTokenSerializer, TokenObtainPairSerializer, UserSerializer
...
class APISendCode(APIView):
    ...
    def post(self, request):
        ...
        email = EmailMessage(
            "Saytimizda royxattan otkaniz ushin rahmat ",
            f"accauntizni activ qilish ushin code:" f"{confirmation_code}",
